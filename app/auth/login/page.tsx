  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="bg-white p-8 rounded-xl shadow-2xl max-w-md w-full">
        <div className="mb-6">
          <Link href="/" className="text-blue-700 hover:text-blue-800 font-bold">
            ← Back to Home
          </Link>
        </div>
        <h1 className="text-2xl font-bold text-center text-gray-900 mb-8">Student Login</h1>
        {error && (
          <div className="bg-red-50 border border-red-200 text-red-800 px-4 py-3 rounded-lg mb-4 font-medium">
            {error}
          </div>
        )}
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            <label className="block text-sm font-bold text-gray-800 mb-1">Student ID</label>
            <input
              type="text"
              value={studentId}
